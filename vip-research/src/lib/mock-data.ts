...
export const RECOMMENDATIONS: Record<string, Recommendation[]> = {
  "vip-1": [
    {
      ...
      relevanceScore: 92,
      aiExplanation:
        "Sarah's tech portfolio has significant cybersecurity exposure. The report estimates the global cybersecurity market at approximately $215 billion in 2026 with 10% growth, and AI powered threats are driving investment in detection and response. Directly relevant to her semiconductor and tech mandate.",
      dismissed: false,
      shared: false,
    },
    {
  ...
  "vip-2": [
    ...
    },
    {
      ...
      relevanceScore: 60,
      aiExplanation:
        "European banks are key lenders to the infrastructure sector. The stress test results show capital adequacy dispersion across institutions, with implications for project finance availability. NII normalization affects Michael's financing cost assumptions for data center capex.",
      dismissed: false,
      shared: false,
    },
  ],
  ...
  "vip-4": [
    ...
    },
    {
      ...
      relevanceScore: 42,
      aiExplanation:
        "Tangential to James's fixed income focus, but crypto regulation is increasingly relevant for institutional portfolio diversification. Spot Bitcoin ETFs have attracted over $60 billion in cumulative inflows and the stablecoin market exceeds $200 billion. Worth monitoring for cross asset implications.",
      dismissed: false,
      shared: false,
    },
  ],
  ...
  "vip-8": [
    {
      ...
      relevanceScore: 80,
      aiExplanation:
        "Carlos is exploring alternative investments for the family office. The report covers institutional custody frameworks and portfolio allocation approaches for digital assets. At $60 billion in Bitcoin ETF inflows, this is increasingly relevant for family office diversification.",
      dismissed: false,
      shared: false,
    },
    {
...
export const AI_INSIGHTS: Record<string, AiInsight> = {
  "vip-1": {
    ...
    body: "Sarah is one of your most active VIPs. She consistently reads 85%+ of shared research and typically opens documents within 2 hours of receiving them. Continue sharing semiconductor, AI infrastructure, and cybersecurity content.",
  },
  "vip-2": {
    type: "negative",
    title: "Engagement Declining",
    body: "Michael's document completion rate dropped from 70% to 52% over the past month. He did not open the oil and gas report. Consider reaching out with the commercial real estate reset or US infrastructure tracker to re engage.",
  },
  "vip-3": {
    type: "negative",
    title: "Engagement Declining",
    body: "Fatima has not opened any research in the last 3 weeks. Her completion rates have dropped from 65% to 15% over the past month. The ESG and oil and gas reports matched her interests best. Consider a re engagement call.",
  },
  "vip-4": {
    type: "positive",
    title: "Top Reader",
    body: "James has read every document you shared this quarter with an average completion of 91%. He is especially engaged with EM fixed income, European banking, and consumer credit content. Consider sharing the US infrastructure tracker early.",
  },
  "vip-5": {
    type: "positive",
    title: "New Interest Detected",
    body: "For the first time, Priya opened the crypto regulation report (25% completion). Combined with her geopolitics focus and Japan monetary policy reading, this signals broadening interest in APAC financial regulation themes.",
  },
  "vip-6": {
    type: "positive",
  ...
  "vip-8": {
    ...
    body: "Carlos engages deeply with ESG and commodity content (75%+) but ignores other topics. His 65% completion on the oil and gas report and 20% on healthcare suggest commodity and ESG remain the key engagement levers.",
  },
};
      ...
      comments: [
        {
          ...
          text: "This memory recovery call is directly relevant to your semiconductor allocation thesis. The pricing power return could inform your overweight positioning on memory names.",
        ...
        },
        {
          ...
          text: "Good timing. I was considering increasing memory exposure. Do we have a view on how long pricing power sustains given the AI inference demand tailwind?",
        ...
        },
        {
          ...
          text: "The report models low to mid single digit revenue growth for 2026 with outperformance in memory. I will flag the AI demand section for your review.",
    ...
    },
    {
      ...
      comments: [
        ...
        },
        {
          ...
          text: "The front loading is key. If deceleration starts in 2027 we need to position now. Can we schedule a call to discuss the semiconductor hardware and power equipment angle?",
      ...
      comments: [
        {
          ...
          text: "Given your portfolio's ESG mandate, the legislative implementation pace is critical. The grid infrastructure section has specific implications for your renewable allocation.",
        ...
        },
        {
          ...
          text: "Thank you for flagging this. The grid investment theme aligns with our infrastructure mandate. We are also interested in the battery storage outlook for our clean energy portfolio.",
      ...
      comments: [
        {
          ...
          text: "James, the EM easing cycle thesis aligns with your duration positioning. The overweight positions in Latin America and EMEA could complement your India allocation.",
        ...
        },
        {
          ...
          text: "Excellent timing. The real yield analysis validates our EM local currency overweight. What is the team's view on the Fed risk scenario and how it affects our EM duration?",
      ...
      comments: [
        {
          ...
          text: "Elena, the BOJ rate path and yen dynamics analysis aligns with the macro view we discussed. The carry trade unwind risk section is worth a closer look for your FX positioning.",
        ...
        },
        {
          ...
          text: "Already adjusting our yen position based on the 140 to 145 target. The carry trade unwind scenario is playing out. What is the team's conviction on the Nikkei downside scenario at 34000 to 36000?",
...
export const SUGGESTED_ACTIONS: Record<string, string[]> = {
  ...
  "vip-2": [
    "Share commercial real estate reset with data center angle",
    "Send follow up on unread oil and gas report",
  ],
  "vip-3": [
    "Share oil and gas rebalancing with energy transition focus",
    "Schedule re engagement call",
    "Adjust research topics to match ESG and carbon themes",
  ],
  "vip-4": [
    "Share US infrastructure capex tracker early",
    "Highlight LatAm and EMEA sections in EM outlook",
  ],
  "vip-5": [
    "Share Japan monetary policy report urgently",
    "Include cybersecurity geopolitical context in next share",
  ],
  "vip-6": [
  ...
  "vip-7": [
    "Share healthcare and biotech outlook for sector rotation signals",
    "Provide 1 page summary of key BOJ rate trade implications",
  ],
  "vip-8": [
    "Share crypto regulation report for family office diversification",
    "Schedule impact investing discussion call",
  ],
};
...
export function personalizeWalkthroughSteps(docId: string, vipId: string | null): WalkthroughStep[] {
  ...
  const vip = MOCK_VIPS.find((v) => v.id === vipId) || null;
